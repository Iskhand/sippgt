...
@section('mainContent')
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $jumpek1 }} Orang</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $jumpek2 }} Orang</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $jumpek3 }} Orang</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
    ...
    <!-- /.row -->
    <script src="{{ $ChartPekerja->cdn() }}"></script>
